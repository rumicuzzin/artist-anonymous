    ...
    <div className="min-h-screen bg-black text-green-400 flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="auth-buttons space-y-4">
          <Link to="/login">
            <button className="login-btn w-full py-3 bg-green-600 text-black font-semibold rounded hover:bg-green-500 transition-colors">
              Login
            </button>
          </Link>
          
          <Link to="/register">
            <button className="register-btn w-full py-3 border-2 border-green-500 text-green-400 font-semibold rounded hover:bg-green-500 hover:text-black transition-colors">
              Sign Up
            </button>
          </Link>
        </div>
